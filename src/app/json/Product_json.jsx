...
export const Candies_Gums_json_Data = [
  {
...
export const Cold_Drinks_and_Juices = [
  {
    ...
    id:41,
    weight: "5 L",
    offercard: <OfferCard_by_ten_percent />,
  },
  {
...
export const Mouth_and_fresheners = [
  {
...
export const Snacks_and_Munchies = [
  {
...
export const Rolling_and_paper_and_tobacco = [
  {
    Product_name: "Perfect Rolled Cones (Natural) - Bongchie",
    image: "/images/31.avif",
    price: 45,
    weight: "6 pack",
    offercard: <OfferCard_by_fiften_percent />,
    id:12
  },
  {
